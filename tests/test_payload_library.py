...
class TestPayloadLibrary(unittest.TestCase):
    ...
    def test_dynamic_builder(self):
        ...
        self.assertAlmostEqual(tab._state["calculated_area"], expected_area, places=4)
        
        # Verify Density
        expected_vol = (4/3) * 3.14159 * 0.1**3
        expected_density = 10.0 / expected_vol
        self.assertAlmostEqual(tab._state["calculated_density"], expected_density, places=1)
